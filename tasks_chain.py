...
from langchain.chains import RetrievalQA, LLMChain, SimpleSequentialChain, LLMCheckerChain, SequentialChain
...
# chains
qa_chain = RetrievalQA.from_chain_type(llm, chain_type="refine", retriever=retriever_all)
