...
from langchain.chains import RetrievalQA, LLMChain, ConstitutionalChain
...
qa = RetrievalQA.from_chain_type(llm, chain_type="refine", retriever=db_law.as_retriever())
